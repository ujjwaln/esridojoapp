/* 
 * MODIFIED VERSION of dojox/form/ListInput. 
 * 07/29/2014 - Ujjwal Narayan
 */
...
var ListInput = declare("mapper.widgets.ListInput", [FormValueWidget],
	...
	inputClass: "mapper.widgets._ListInputInputBox",
	...
	add: function(/*String|Array*/ values){
		...
		for(var i in values){
			...
			//changing this to allow items to be stored
			// var value=values[i];
            // if(value === "" || typeof value != "string"){
				// continue;
			// }
			var labelAttr = this.get("labelAttr");
			if (!values[i].hasOwnProperty(labelAttr)) {
			    continue;
			}
			var value = values[i][labelAttr];
...
var _ListInputInputItem = declare("mapper.widgets._ListInputInputItem", [Widget, TemplatedMixin],
	{
	// summary:
...
var _ListInputInputBox = declare("mapper.widgets._ListInputInputBox", [ValidationTextBox],
	{
	// summary:
	//		auto-sized text box
	// description:
